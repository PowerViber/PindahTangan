...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-[#F6F3F2] border-r border-[#D1C5B8] min-h-screen py-6 px-6 flex flex-col">
      ...
      <button className="bg-[#725A39] hover:bg-[#5B4526] text-white rounded-lg py-3 flex items-center justify-center gap-2 font-body font-bold text-sm transition-colors cursor-pointer shadow-xs">
