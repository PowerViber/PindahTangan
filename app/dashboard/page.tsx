...
const actionItems = [
  { title: "MacBook Pro 14\" — Tawaran Baru", desc: "Calon pembeli menawar $1,150 untuk barangmu.", time: "12m lalu", highlighted: true },
  { title: "Bid Baru di iPhone 13",           desc: "Tawaran sebesar $620 telah diterima.",          time: "1j lalu",  highlighted: false },
  { title: "Pickup Terjadwal",                desc: "Kurir akan datang besok pukul 10:00–12:00.",     time: "3j lalu",  highlighted: false },
];

const feed = [
  { name: "MacBook Pro 14\" (2021)", price: "$1,800", grade: "MINT" },
  { name: "Sony WH-1000XM4",         price: "$220",   grade: "GOOD" },
  { name: "iPad Air (2022)",         price: "$390",   grade: "GOOD" },
  { name: "Canon EOS M50",           price: "$540",   grade: "FAIR" },
];
    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 pb-6">
        ...
        <div className="flex gap-3">
          <Link
            href="/jual"
            className="flex items-center gap-2 border border-[#1B1C1C] text-[#1B1C1C] font-body font-medium text-sm px-6 py-3 rounded-sm hover:bg-[#F6F3F2] transition-colors"
          >
